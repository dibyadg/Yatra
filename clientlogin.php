...
?>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: white; background: #555555 ;">
        ...
        <div class="container_head" style="margin:110px;">
            
                <h1 class="text-center">Yatra - Admin Panel </span>
                </h1>
                <br>
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <div class="panel p-4" style="background-color:#EEEEEE; color:#555555 ">
                ...
                <label class="btn btn-secondary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
            </span>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                <label class="btn btn-secondary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                                        </span>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-4">
                                    <button class="btn btn-submit" name="submit" type="submit" value=" Login " style="background:#555555; color:#fff">Submit</button>
