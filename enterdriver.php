...
<body>
 ...
 <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: white; background: #555555;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="clientlogin.php">Yatra</a>
                    </li>
                    <li>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area" style="margin-top:70px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
           ...
           <button type="submit" id="submit" name="submit" class="btn pull-right" style="background:#555555;color:#fff"> Add Driver</button>    
        </form>
      </div>
    </div>
