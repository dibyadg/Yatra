...
<head>
    <title> Admin Signup | Yatra  </title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron" style="margin-top:70px;">
            <h1 class="text-center">Yatra - Registration</h1>
            <br>
        ...
        <div class="col-md-5 col-md-offset-4">
            <div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <label class="btn " style="background:#555555; color:#fff"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
              </span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn " style="background:#555555; color:#fff"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></label>
              </span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn " style="background:#555555; color:#fff"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span></label>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn " style="background:#555555; color:#fff"><span class="glyphicon glyphicon-home" aria-hidden="true"></label>
              </span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn " style="background:#555555; color:#fff"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-4">
                                <button class="btn " style="background:#555555; color:#fff" type="submit">Submit</button>
                            </div>
