...
?>
    ...
    <head>
        <title> Customer Login | Yatra </title>
    </head>
    ...
    <link rel="stylesheet" href="assets/css/logincustomer.css">
...
<!-- 
        ...
        <div class="container_head">
            <h1 class="text-center">Yatra - Customer Panel </span>
                </h1>
                <br>
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <label class="btn "><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-4">
                                    <button class="btn btn-submit" name="submit" type="submit" value=" Login ">Submit</button>
