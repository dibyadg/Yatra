...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: White; background: #555555;">
    ...
    <h2 class="text-center"> Thank you for using Yatra! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <h3 style="color: #666666;">Your booking has been received and placed into out order processing system.</h3>
                <br>
                ...
                <br>
                <h3 style="color: #666666;">Invoice</h3>
                <br>
            </div>
